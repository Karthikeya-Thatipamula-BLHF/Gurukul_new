...
// Chat API base URL configuration
    ...
    fetchAvatarChatResponse: builder.query({
      ...
      transformResponse: (response) => {
        ...
        if (
          ...
          return {
            message:
              "Hi! I'm your AI avatar assistant. I can help you with anything on this page. What would you like to know?",
            isFirstQuery: true,
          };
        }
        return response;
 ...
 */
export const formatAvatarMessage = (
  message,
  role = "user",
  model = "grok"
) => ({
...
export const createAvatarSystemPrompt = (pageContext) => {
  ...
  const contextualPrompts = {
    dashboard:
      "Help the user navigate the dashboard and understand their learning progress.",
    academic: "Assist with subject selection and academic planning.",
    learning:
      "Help with document analysis, summarization, and learning activities.",
    ...
    information:
      "Provide information about platform features and capabilities.",
  };

  const specificPrompt =
    contextualPrompts[routeContext.type] || "Provide general assistance.";
